...
Software Requirement Specification (SRS) - 01-sofware-requirement-spesification.md
User Flows (UF) - 02 userflow coffeeloyalty.md
Design System (DS) - 04-design-system.md
Information Architecture (IA) - 03-informationarchitecture-coffeeloyalty.md
